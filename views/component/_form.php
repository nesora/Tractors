            ...
            <div   class="input_fields_wrap">
                ...
                <?php if (isset($depModels)) : ?> 
                    ...
                    <div class="col-md-12 ">
                        ...
                        <div class="col-md-4 ">
                            <input type="text" name="ids[0][quantity]" class="form-control" placeholder="Enter amount"  >
                        </div>


                        <div class="btn btn-default add_field_button"><span class="glyphicon glyphicon-plus"></span></div>
